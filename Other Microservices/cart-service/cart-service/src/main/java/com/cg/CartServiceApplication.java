...
public class CartServiceApplication {
	...
	private ApiInfo myApiInfo() {
		...
		return new ApiInfo(
				...
				"1.0",
				"Free to use",
				new springfox.documentation.service.Contact("Ranvijay Kumar", "http://localhost:2222/swagger-ui.html#/", "rannvijaykr007@gmail.com"),
				"Api Licence",
...
//				new Contact("Ranvijay Kumar", "/limits", "rannvijaykr007@gmail.com"), "API licence", "/limits",
//				Collections.emptyList());
//		return apiInfo;
	}
